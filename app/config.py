...
class Settings(BaseSettings):
    # Рекомендуется использовать Qwen2.5-7B-Instruct для лучшего качества генерации
    # Для более быстрой модели можно использовать:
    # - Qwen/Qwen2.5-3B-Instruct (быстрее в 2-3 раза на CPU)
    ...
    # Рекомендуется включить для модели 7B на CPU
